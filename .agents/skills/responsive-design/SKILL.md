...
- [Fluid layouts and typography](references/fluid-layouts.md)
- [Container queries](references/container-queries.md)
- [Breakpoint strategies](references/breakpoint-strategies.md)

_Source: [wshobson/agents](https://github.com/wshobson/agents) — `plugins/ui-design/skills/responsive-design` (published on [agentskill.sh](https://agentskill.sh/@wshobson/responsive-design))._
